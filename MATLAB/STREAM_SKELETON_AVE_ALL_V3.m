function [out] = STREAM_SKELETON_AVE_ALL_V3 ( inpData )
...
svmAVE.outSVMlinear_R3_ERR = (abs(mean([svm(:).outSVMlinear_3])-mean([svm(:).outSVMlinear_R3],1)));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmAVE.outSVMrbf_RBF1_R3_ERR = (abs(mean([svm(:).outSVMrbf_3])-mean([svm(:).outSVMrbf_R3],1)));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
