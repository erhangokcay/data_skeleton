function [out] = STREAM_SKELETON_AVE_ALL_V2 ( inp )
...
svmAVE.outSVMlinear_R1_ERR = (abs(mean([svm(:).outSVMlinear_1],1)-mean([svm(:).outSVMlinear_R1],1)));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmAVE.outSVMrbf_RBF1_R1_ERR = (abs(mean([svm(:).outSVMrbf_1],1)-mean([svm(:).outSVMrbf_R1],1)));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmAVE.outSVMrbf_RBF2_R1_ERR = (abs(mean([svm(:).outSVMrbf_1_1],1)-mean([svm(:).outSVMrbf_1_R1],1)));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmAVE.outSVMrbf_RBF3_R1_ERR = (abs(mean([svm(:).outSVMrbf_2_1],1)-mean([svm(:).outSVMrbf_2_R1],1)));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmAVE.outSVMrbf_RBF4_R1_ERR = (abs(mean([svm(:).outSVMrbf_3_1],1)-mean([svm(:).outSVMrbf_3_R1],1)));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmAVE.outSVMrbf_RBF5_R1_ERR = (abs(mean([svm(:).outSVMrbf_4_1],1)-mean([svm(:).outSVMrbf_4_R1],1)));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);
%
svmAVE.outSVMlinear_R2_ERR = (abs(mean([svm(:).outSVMlinear_2],1)-mean([svm(:).outSVMlinear_R2],1)));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmAVE.outSVMrbf_RBF1_R2_ERR = (abs(mean([svm(:).outSVMrbf_2],1)-mean([svm(:).outSVMrbf_R2],1)));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmAVE.outSVMrbf_RBF2_R2_ERR = (abs(mean([svm(:).outSVMrbf_1_2],1)-mean([svm(:).outSVMrbf_1_R2],1)));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmAVE.outSVMrbf_RBF3_R2_ERR = (abs(mean([svm(:).outSVMrbf_2_2],1)-mean([svm(:).outSVMrbf_2_R2],1)));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmAVE.outSVMrbf_RBF4_R2_ERR = (abs(mean([svm(:).outSVMrbf_3_2],1)-mean([svm(:).outSVMrbf_3_R2],1)));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmAVE.outSVMrbf_RBF5_R2_ERR = (abs(mean([svm(:).outSVMrbf_4_2],1)-mean([svm(:).outSVMrbf_4_R2],1)));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);

svmAVE.outSVMlinear_R3_ERR = (abs(mean([svm(:).outSVMlinear_3],1)-mean([svm(:).outSVMlinear_R3],1)));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmAVE.outSVMrbf_RBF1_R3_ERR = (abs(mean([svm(:).outSVMrbf_3],1)-mean([svm(:).outSVMrbf_R3],1)));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmAVE.outSVMrbf_RBF2_R3_ERR = (abs(mean([svm(:).outSVMrbf_1_3],1)-mean([svm(:).outSVMrbf_1_R3],1)));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmAVE.outSVMrbf_RBF3_R3_ERR = (abs(mean([svm(:).outSVMrbf_2_3],1)-mean([svm(:).outSVMrbf_2_R3],1)));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmAVE.outSVMrbf_RBF4_R3_ERR = (abs(mean([svm(:).outSVMrbf_3_3],1)-mean([svm(:).outSVMrbf_3_R3],1)));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmAVE.outSVMrbf_RBF5_R3_ERR = (abs(mean([svm(:).outSVMrbf_4_3],1)-mean([svm(:).outSVMrbf_4_R3],1)));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);
