...
%     end
    ...
    stat1Dim.covar =  statInfo.covar(1);
    stat1Dim.det =  statInfo.cvdet(1);
    stat1Dim.cvinv =  statInfo.cvinv(1);
...
%         end        
    ...
    [clust,numC]=CPP_Recluster(clust(1:numC),numC,var,T2,statInfo) ;
...
%                 end                                
       ...
       if ( mod(n,1000)==0)
           ...
           memory
           tic;[clust,numC]=CPP_Recluster(clust(1:numC),numC,var,T2,statInfo) ;toc
       end
       
       
       if ( mod(n,10000)==0)
           %save matlab_skeleton_27_02_2023 xy clust numC n randlist
       end
       %%%%%% ---------------------- START ---------------------------------
