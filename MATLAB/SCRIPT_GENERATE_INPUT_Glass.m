...
data_Glass = getData_Glass;
%TList_IRIS_1=[1000,500,100,10,1,0.1, 10e-3,10e-4,10e-5,10e-8,10e-25,10e-50,10e-200,10e-350,10e-500]
% T=0 means original dataset. Copy by hand, not in the loop
TList_Glass_1=[ 1e6, 1e5, 1e0, 1e-10, 1e-50, 1e-100, 1e-200];
TList = TList_Glass_1;
cef_var=0.15;
RdSelect = 1;
...
for T=1:length(TList)    
    for n=1:10
        ...
        inpstrGlass(T,n) = STREAM_SKELETON_INPUT_DATASET_OPTIMIZED ( data_Glass, 0.2, false, [], 0.075, TList(T), TList(T) );
...
%save MATLAB_Glass_11_03_2021.mat
