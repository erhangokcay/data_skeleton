function [clust,numOfClust]=STREAM_SKELETON_VER4_nPNT_OPTIMIZED_V2_MEM_DEBUG1(xy,var,T1,T2,randlist)
...
%         end        
    ...
    [clust,numC]=STREAM_SKELETON_RECLUSTER_VER3_OPTIMIZED_MEM_DEBUG1(clust,clustEmpty,numC,var,T2) ;
    %[globalTmean, globalTvar]= STREAM_CLUSTER_STAT(clust,var); % this should be incremental
...
% % %     end
    ...
    for n=4:len
        if ( DEBUG_DISP ) fprintf('n=%d numC=%d \n',n,numC); end
