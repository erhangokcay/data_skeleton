...
% DIFFERENT IN MATLAB FILE
TList_Cardiotocography_1=[1e12,   1e11,    1e10,  1e5, 1e-0,   1e-5,  1e-20,  1e-50];
...
for T=1:length(TList)    
    for n=1:10
        ...
        inpstrCardiotocography(T,n) = STREAM_SKELETON_INPUT_DATASET_OPTIMIZED ( data_Cardiotocography, 0.2, false, [], 0.1, TList(T), TList(T) );
...
save MATLAB_Cardiotocography_10_03_2021.mat
