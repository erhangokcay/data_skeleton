function [out] = STREAM_SKELETON_AVE_ALL_V1 ( inp )
...
% --------------------------------------------
aveVAL.knn_euc_R1_euc_precision_ERR = mean( abs([aveVAL.knn_euc_R1_NORMAL.euc_precision]-[aveVAL.knn_euc_R1_REDUCED.euc_precision]),2)';
aveVAL.knn_euc_R1_euc_recall_ERR = mean( abs([aveVAL.knn_euc_R1_NORMAL.euc_recall]-[aveVAL.knn_euc_R1_REDUCED.euc_recall]),2)';
aveVAL.knn_euc_R2_euc_precision_ERR = mean( abs([aveVAL.knn_euc_R2_NORMAL.euc_precision]-[aveVAL.knn_euc_R2_REDUCED.euc_precision]),2)';
aveVAL.knn_euc_R2_euc_recall_ERR = mean( abs([aveVAL.knn_euc_R2_NORMAL.euc_recall]-[aveVAL.knn_euc_R2_REDUCED.euc_recall]),2)';
aveVAL.knn_euc_R3_euc_precision_ERR = mean( abs([aveVAL.knn_euc_R3_NORMAL.euc_precision]-[aveVAL.knn_euc_R3_REDUCED.euc_precision]),2)';
aveVAL.knn_euc_R3_euc_recall_ERR = mean( abs([aveVAL.knn_euc_R3_NORMAL.euc_recall]-[aveVAL.knn_euc_R3_REDUCED.euc_recall]),2)';

aveVAL.knn_euc_R1_mah_precision_ERR = mean( abs([aveVAL.knn_mah_R1_NORMAL.mah_precision]-[aveVAL.knn_mah_R1_REDUCED.mah_precision]),2)';
aveVAL.knn_euc_R1_mah_recall_ERR    = mean( abs([aveVAL.knn_mah_R1_NORMAL.mah_recall]   -[aveVAL.knn_mah_R1_REDUCED.mah_recall]),2)';
aveVAL.knn_euc_R2_mah_precision_ERR = mean( abs([aveVAL.knn_mah_R2_NORMAL.mah_precision]-[aveVAL.knn_mah_R2_REDUCED.mah_precision]),2)';
aveVAL.knn_euc_R2_mah_recall_ERR    = mean( abs([aveVAL.knn_mah_R2_NORMAL.mah_recall]   -[aveVAL.knn_mah_R2_REDUCED.mah_recall]),2)';
aveVAL.knn_euc_R3_mah_precision_ERR = mean( abs([aveVAL.knn_mah_R3_NORMAL.mah_precision]-[aveVAL.knn_mah_R3_REDUCED.mah_precision]),2)';
aveVAL.knn_euc_R3_mah_recall_ERR    = mean( abs([aveVAL.knn_mah_R3_NORMAL.mah_recall]   -[aveVAL.knn_mah_R3_REDUCED.mah_recall]),2)';
%=================================
stdVAL.knn_euc_R1_euc_precision_ERR = std( abs([aveVAL.knn_euc_R1_NORMAL.euc_precision]-[aveVAL.knn_euc_R1_REDUCED.euc_precision]),0,2)';
stdVAL.knn_euc_R1_euc_recall_ERR = std( abs([aveVAL.knn_euc_R1_NORMAL.euc_recall]-[aveVAL.knn_euc_R1_REDUCED.euc_recall]),0,2)';
stdVAL.knn_euc_R2_euc_precision_ERR = std( abs([aveVAL.knn_euc_R2_NORMAL.euc_precision]-[aveVAL.knn_euc_R2_REDUCED.euc_precision]),0,2)';
stdVAL.knn_euc_R2_euc_recall_ERR = std( abs([aveVAL.knn_euc_R2_NORMAL.euc_recall]-[aveVAL.knn_euc_R2_REDUCED.euc_recall]),0,2)';
stdVAL.knn_euc_R3_euc_precision_ERR = std( abs([aveVAL.knn_euc_R3_NORMAL.euc_precision]-[aveVAL.knn_euc_R3_REDUCED.euc_precision]),0,2)';
stdVAL.knn_euc_R3_euc_recall_ERR = std( abs([aveVAL.knn_euc_R3_NORMAL.euc_recall]-[aveVAL.knn_euc_R3_REDUCED.euc_recall]),0,2)';

stdVAL.knn_euc_R1_mah_precision_ERR = std( abs([aveVAL.knn_mah_R1_NORMAL.mah_precision]-[aveVAL.knn_mah_R1_REDUCED.mah_precision]),0,2)';
stdVAL.knn_euc_R1_mah_recall_ERR    = std( abs([aveVAL.knn_mah_R1_NORMAL.mah_recall]   -[aveVAL.knn_mah_R1_REDUCED.mah_recall]),0,2)';
stdVAL.knn_euc_R2_mah_precision_ERR = std( abs([aveVAL.knn_mah_R2_NORMAL.mah_precision]-[aveVAL.knn_mah_R2_REDUCED.mah_precision]),0,2)';
stdVAL.knn_euc_R2_mah_recall_ERR    = std( abs([aveVAL.knn_mah_R2_NORMAL.mah_recall]   -[aveVAL.knn_mah_R2_REDUCED.mah_recall]),0,2)';
stdVAL.knn_euc_R3_mah_precision_ERR = std( abs([aveVAL.knn_mah_R3_NORMAL.mah_precision]-[aveVAL.knn_mah_R3_REDUCED.mah_precision]),0,2)';
stdVAL.knn_euc_R3_mah_recall_ERR    = std( abs([aveVAL.knn_mah_R3_NORMAL.mah_recall]   -[aveVAL.knn_mah_R3_REDUCED.mah_recall]),0,2)';

%--------------------------------------------------------------------------------

aveVAL.knn_euc_R1_ERR = mean(abs([aveV.knn_euc_R1]-[aveV.knn_euc_1]));
% aveVAL.knn_euc_1 = mean([aveV.knn_euc_1]);
aveVAL.knn_mah_R1_ERR = mean(abs([aveV.knn_mah_R1]-[aveV.knn_mah_1]));
%aveVAL.knn_mah_1 = mean([aveV.knn_mah_1]);
%aveVAL.knn_ker_R1 = mean([aveV(:).knn_ker_R1]);
%aveVAL.knn_ker_1 = mean([aveV(:).knn_ker_1]);
%
aveVAL.knn_euc_R2_ERR = mean(abs([aveV.knn_euc_R2]-[aveV.knn_euc_2]));
% aveVAL.knn_euc_2  = mean([aveV.knn_euc_2]);
aveVAL.knn_mah_R2_ERR = mean(abs([aveV.knn_mah_R2]-[aveV.knn_mah_2]));
%aveVAL.knn_mah_2  = mean([aveV.knn_mah_2]);
%aveVAL.knn_ker_R2 = mean([aveV(:).knn_ker_R2]);
%aveVAL.knn_ker_2  = mean([aveV(:).knn_ker_2]);
%
aveVAL.knn_euc_R3_ERR = mean(abs([aveV.knn_euc_R3]-[aveV.knn_euc_3]));
% aveVAL.knn_euc_3  = mean([aveV.knn_euc_3]);
aveVAL.knn_mah_R3_ERR = mean(abs([aveV.knn_mah_R3]-[aveV.knn_mah_3]));
...
stdVAL.knn_euc_R1_ERR = std(abs([aveV.knn_euc_R1]-[aveV.knn_euc_1]));
% stdVAL.knn_euc_1 = std([aveV.knn_euc_1]);
stdVAL.knn_mah_R1_ERR = std(abs([aveV.knn_mah_R1]-[aveV.knn_mah_1]));
% stdVAL.knn_mah_1 = std([aveV.knn_mah_1]);

%stdVAL.knn_ker_R1 = std([aveV(:).knn_ker_R1]);
%stdVAL.knn_ker_1 = std([aveV(:).knn_ker_1]);
%
stdVAL.knn_euc_R2_ERR = std(abs([aveV.knn_euc_R2]-[aveV.knn_euc_2]));
% stdVAL.knn_euc_2 = std([aveV.knn_euc_2]);
stdVAL.knn_mah_R2_ERR = std(abs([aveV.knn_mah_R2]-[aveV.knn_mah_2]));
%stdVAL.knn_mah_2 = std([aveV.knn_mah_2]);

%stdVAL.knn_ker_R2 = std([aveV(:).knn_ker_R2]);
%stdVAL.knn_ker_2 = std([aveV(:).knn_ker_2]);
%
stdVAL.knn_euc_R3_ERR = std(abs([aveV.knn_euc_R3]-[aveV.knn_euc_3]));
% stdVAL.knn_euc_3 = std([aveV.knn_euc_3]);
stdVAL.knn_mah_R3_ERR = std(abs([aveV.knn_mah_R3]-[aveV.knn_mah_3]));
...
svmAVE.outSVMlinear_R1_ERR = mean(abs([svm(:).outSVMlinear_1]-[svm(:).outSVMlinear_R1]));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmAVE.outSVMrbf_RBF1_R1_ERR = mean(abs([svm(:).outSVMrbf_1]-[svm(:).outSVMrbf_R1]));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmAVE.outSVMrbf_RBF2_R1_ERR = mean(abs([svm(:).outSVMrbf_1_1]-[svm(:).outSVMrbf_1_R1]));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmAVE.outSVMrbf_RBF3_R1_ERR = mean(abs([svm(:).outSVMrbf_2_1]-[svm(:).outSVMrbf_2_R1]));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmAVE.outSVMrbf_RBF4_R1_ERR = mean(abs([svm(:).outSVMrbf_3_1]-[svm(:).outSVMrbf_3_R1]));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmAVE.outSVMrbf_RBF5_R1_ERR = mean(abs([svm(:).outSVMrbf_4_1]-[svm(:).outSVMrbf_4_R1]));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);
%
svmAVE.outSVMlinear_R2_ERR = mean(abs([svm(:).outSVMlinear_2]-[svm(:).outSVMlinear_R2]));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmAVE.outSVMrbf_RBF1_R2_ERR = mean(abs([svm(:).outSVMrbf_2]-[svm(:).outSVMrbf_R2]));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmAVE.outSVMrbf_RBF2_R2_ERR = mean(abs([svm(:).outSVMrbf_1_2]-[svm(:).outSVMrbf_1_R2]));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmAVE.outSVMrbf_RBF3_R2_ERR = mean(abs([svm(:).outSVMrbf_2_2]-[svm(:).outSVMrbf_2_R2]));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmAVE.outSVMrbf_RBF4_R2_ERR = mean(abs([svm(:).outSVMrbf_3_2]-[svm(:).outSVMrbf_3_R2]));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmAVE.outSVMrbf_RBF5_R2_ERR = mean(abs([svm(:).outSVMrbf_4_2]-[svm(:).outSVMrbf_4_R2]));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);

svmAVE.outSVMlinear_R3_ERR = mean(abs([svm(:).outSVMlinear_3]-[svm(:).outSVMlinear_R3]));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmAVE.outSVMrbf_RBF1_R3_ERR = mean(abs([svm(:).outSVMrbf_3]-[svm(:).outSVMrbf_R3]));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmAVE.outSVMrbf_RBF2_R3_ERR = mean(abs([svm(:).outSVMrbf_1_3]-[svm(:).outSVMrbf_1_R3]));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmAVE.outSVMrbf_RBF3_R3_ERR = mean(abs([svm(:).outSVMrbf_2_3]-[svm(:).outSVMrbf_2_R3]));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmAVE.outSVMrbf_RBF4_R3_ERR = mean(abs([svm(:).outSVMrbf_3_3]-[svm(:).outSVMrbf_3_R3]));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmAVE.outSVMrbf_RBF5_R3_ERR = mean(abs([svm(:).outSVMrbf_4_3]-[svm(:).outSVMrbf_4_R3]));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);
...
svmSTD.outSVMlinear_R1_ERR = std(abs([svm(:).outSVMlinear_1]-[svm(:).outSVMlinear_R1]));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmSTD.outSVMrbf_RBF1_R1_ERR = std(abs([svm(:).outSVMrbf_1]-[svm(:).outSVMrbf_R1]));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmSTD.outSVMrbf_RBF2_R1_ERR = std(abs([svm(:).outSVMrbf_1_1]-[svm(:).outSVMrbf_1_R1]));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmSTD.outSVMrbf_RBF3_R1_ERR = std(abs([svm(:).outSVMrbf_2_1]-[svm(:).outSVMrbf_2_R1]));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmSTD.outSVMrbf_RBF4_R1_ERR = std(abs([svm(:).outSVMrbf_3_1]-[svm(:).outSVMrbf_3_R1]));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmSTD.outSVMrbf_RBF5_R1_ERR = std(abs([svm(:).outSVMrbf_4_1]-[svm(:).outSVMrbf_4_R1]));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);
%
svmSTD.outSVMlinear_R2_ERR = std(abs([svm(:).outSVMlinear_2]-[svm(:).outSVMlinear_R2]));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmSTD.outSVMrbf_RBF1_R2_ERR = std(abs([svm(:).outSVMrbf_2]-[svm(:).outSVMrbf_R2]));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmSTD.outSVMrbf_RBF2_R2_ERR = std(abs([svm(:).outSVMrbf_1_2]-[svm(:).outSVMrbf_1_R2]));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmSTD.outSVMrbf_RBF3_R2_ERR = std(abs([svm(:).outSVMrbf_2_2]-[svm(:).outSVMrbf_2_R2]));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmSTD.outSVMrbf_RBF4_R2_ERR = std(abs([svm(:).outSVMrbf_3_2]-[svm(:).outSVMrbf_3_R2]));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmSTD.outSVMrbf_RBF5_R2_ERR = std(abs([svm(:).outSVMrbf_4_2]-[svm(:).outSVMrbf_4_R2]));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);

svmSTD.outSVMlinear_R3_ERR = std(abs([svm(:).outSVMlinear_3]-[svm(:).outSVMlinear_R3]));      
% svmAVE.outSVMlinear_R1 = mean([svm(:).outSVMlinear_R1]);    
svmSTD.outSVMrbf_RBF1_R3_ERR = std(abs([svm(:).outSVMrbf_3]-[svm(:).outSVMrbf_R3]));         
% svmAVE.outSVMrbf_R1 = mean([svm(:).outSVMrbf_R1]);       
svmSTD.outSVMrbf_RBF2_R3_ERR = std(abs([svm(:).outSVMrbf_1_3]-[svm(:).outSVMrbf_1_R3]));       
%svmAVE.outSVMrbf_1_R1 = mean([svm(:).outSVMrbf_1_R1]);     
svmSTD.outSVMrbf_RBF3_R3_ERR = std(abs([svm(:).outSVMrbf_2_3]-[svm(:).outSVMrbf_2_R3]));       
% svmAVE.outSVMrbf_2_R1 = mean([svm(:).outSVMrbf_2_R1]);
svmSTD.outSVMrbf_RBF4_R3_ERR = std(abs([svm(:).outSVMrbf_3_3]-[svm(:).outSVMrbf_3_R3]));       
%svmAVE.outSVMrbf_3_R1 = mean([svm(:).outSVMrbf_3_R1]);
svmSTD.outSVMrbf_RBF5_R3_ERR = std(abs([svm(:).outSVMrbf_4_3]-[svm(:).outSVMrbf_4_R3]));       
%svmAVE.outSVMrbf_4_R1 = mean([svm(:).outSVMrbf_4_R1]);
