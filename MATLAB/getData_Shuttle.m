function [inp_str,inp_data] = getData_Shuttle 
    ...
    total_inp_label=[];
        ...
        fname = 'C:\Users\erhan\Documents\Improved Data Skeleton and Performance\DATASETS\Statlog Shuttle\shuttle.trn';
        fid=fopen(fname,'r');
        % Missing Numeric Fields : ? --> 0 
        A=textscan(fid,'%d%d%d%d%d%d%d%d%d%d','Delimiter',' ');
        size(A)
        Nrows = size(A{1},1)
        Ncols = size(A,2)
    ...
    % % %     end
        ...
        fname = 'C:\Users\erhan\Documents\Improved Data Skeleton and Performance\DATASETS\Statlog Shuttle\shuttle.tst';
        fid=fopen(fname,'r');
        % Missing Numeric Fields : ? --> 0 
        A=textscan(fid,'%d%d%d%d%d%d%d%d%d%d','Delimiter',' ');
        size(A)
