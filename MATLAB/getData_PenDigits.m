function [inp_str,inp_data] = getData_PenDigits 
    ...
    total_inp_label=[];
        ...
        fname = 'C:\Users\erhan\Documents\Improved Data Skeleton and Performance\DATASETS\Pen-Based Recognition\pendigits.tra';
        fid=fopen(fname,'r');
        % Missing Numeric Fields : ? --> 0 
        A=textscan(fid,'%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d','Delimiter',',');
        size(A)
        Nrows = size(A{1},1)
        Ncols = size(A,2)
    ...
    % % %     end
        ...
        fname = 'C:\Users\erhan\Documents\Improved Data Skeleton and Performance\DATASETS\Pen-Based Recognition\pendigits.tes';
        fid=fopen(fname,'r');
        % Missing Numeric Fields : ? --> 0 
        A=textscan(fid,'%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d%d','Delimiter',',');
        size(A)
