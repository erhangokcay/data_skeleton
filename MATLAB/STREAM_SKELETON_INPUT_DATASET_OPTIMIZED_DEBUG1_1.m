...
function [out] = STREAM_SKELETON_INPUT_DATASET_OPTIMIZED_DEBUG1_1 ( inp_str, percent, flag, str, std1, T1, T2 )
...
for n=1:Nlabels
    ...
    [clust,numOfClust]=STREAM_SKELETON_VER4_nPNT_OPTIMIZED_V2_MEM_DEBUG1_1(cl,std1,T1,T2, []);
