...
%data_Connectionist_Bench = getData_Connectionist_Bench;
%TList_IRIS_1=[1000,500,100,10,1,0.1, 10e-3,10e-4,10e-5,10e-8,10e-25,10e-50,10e-200,10e-350,10e-500]
% T=0 means original dataset. Copy by hand, not in the loop
TList_Connectionist_Bench_1=[ 1e10, 1e-0, 1e-20,  1e-50,1e-100, 1e-150,1e-200];
TList = TList_Connectionist_Bench_1;
cef_var=0.2;
RdSelect = 1;
clear inpstrConnectionist_Bench;
% clear outArr stroutArr outAVEArr_1 outAVEArr_2
for T=1:length(TList)    
    for n=1:10
        disp(sprintf('T=%f n=%f\n',T,n))
        inpstrConnectionist_Bench(T,n) = STREAM_SKELETON_INPUT_DATASET_OPTIMIZED ( data_Connectionist_Bench, 0.2, false, [], 0.15, TList(T), TList(T) );
...
%save MATLAB_Connectionist_Bench_11_03_2021.mat
