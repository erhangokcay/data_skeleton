...
#include "CPP_Skeleton_Similarity_OPTIMIZED_V1_HPP_FAST.h"
                  ...
                  int nrhs, const mxArray *prhs[] )
{
    ...
    const char *field_names[] = {"xy", "grp", "DCirCef", "maxDist", "IntCef", "outMAXPointList", "maxListNew", "maxValueNew", "modified" };
                    ...
                    if ( dims_n[1] == 1 &&  dims_m[1] == 1)  {    
                        ...
                        */
                        ...
                        for (int h=0; h<dims_n[1]; h++) {
                            ...
                            //cout << " inside else if < dims = " << h << endl;
