...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {                      
	...
	double *ave1 = mxGetPr(plhs[1]);
	double *ave2 = mxGetPr(plhs[2]);


    *outMatrix = skeleton_distance_euc_minave(xp, cell1, cell2, (mwSize)nxp, (mwSize)ncols1, (mwSize)ncols2, (mwSize)Nfeat, ave1, ave2 );
